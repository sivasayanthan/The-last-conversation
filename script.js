...
typeLine(line1,"Connection Established...",50,()=>{

typeLine(line2,"Identity Unknown...",50,()=>{

typeLine(line3,"Beginning Final Session...",50,()=>{
...
typeLine(line1,"Previous answers archived...",70,()=>{

typeLine(line2,"Only one question remains...",70,()=>{

typeLine(line3,"Answer carefully.",70,()=>{
...
"Your mind revealed more than you expected."

];



typeEnding(0,finalMessages);
...
function typeEnding(index,messages){
...
fadeInText(p,messages[index],0,()=>{


setTimeout(()=>{

typeEnding(index+1,messages);
